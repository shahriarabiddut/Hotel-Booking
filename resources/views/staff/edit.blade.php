...
@section('content')
    ...
    <!-- Page Heading -->
    <h1 class="h3 mb-2 text-gray-800">Editing Staff: {{ $data->full_name }}</h1>
            ...
            <form method="POST" action="{{ route('staff.update',$data->id) }}" enctype="multipart/form-data">
                ...
                <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
                    ...
                    <tr>
                        ...
                        <td><input required name="full_name" type="text" class="form-control" value="{{ $data->full_name }}"></td>
                    </tr><tr>
                        <th>Bio</th>
                        ...
                        <td>
                            <input @if ($data->salary_type =='daily')
                                @checked(true)
                            @endif required name="salary_type" type="radio" value="daily"> Daily
                            <input @if ($data->salary_type =='monthly')
                            @checked(true)
                        @endif required name="salary_type" type="radio" value="monthly"> Monthly
                        
                        </td>
                    </tr><tr>
                        <th>Salary Amount<span class="text-danger">*</span></th>
                        <td><input required name="salary_amount" type="text" class="form-control" value="{{ $data->salary_amount }}"></td>
                    </tr
                    <tr>
                        <td colspan="2">
